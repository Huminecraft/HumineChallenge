...
import fr.challenge.utils.challenges.ChallengeEnchantItem;

public class AddChallengeEnchantItemCommand implements CommandExecutor{

	private static final String COMMAND = "/addchallengeenchantitem <title> <ItemToEnchant> <amount> [premium] [description]";
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(item == null) {
			ChallengeMain.sendMessage(sender, "ItemToEnchant invalide");
			ChallengeMain.sendMessage(sender, COMMAND);
			return false;
		}
		...
		ChallengeEnchantItem challenge = new ChallengeEnchantItem(args[0], description, new ItemStack(item), Integer.parseInt(args[2]), premium);
		...
		ChallengeMain.sendMessage(sender, "ChallengeEnchantItem " + args[0] + " ajoute !");
		return true;
	}
}
